...
<div class="page-header">
        <h1>Certifications / Show #{{$certification->id}}</h1>
        <form action="{{ route('certifications.destroy', $certification->id) }}" method="POST" style="display: inline;" onsubmit="if(confirm('Delete? Are you sure?')) { return true } else {return false };">
            ...
            <div class="btn-group pull-right" role="group" aria-label="...">
                <a class="btn btn-warning btn-group" role="group" href="{{ route('certifications.edit', $certification->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a>
        ...
        <div class="col-md-12">
            ...
            <form action="#">
                ...
                <div class="form-group">
                     ...
                     <p class="form-control-static">{{$certification->name}}</p>
                </div>
                    <div class="form-group">
                     <label for="description">DESCRIPTION</label>
                     <p class="form-control-static">{{$certification->description}}</p>
                </div>
                    <div class="form-group">
