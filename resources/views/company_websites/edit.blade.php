...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Company_websites / Edit #{{$company_website->id}}</h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('company_websites.update', $company_website->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('name')) has-error @endif">
                    ...
                    <input type="text" id="name-field" name="name" class="form-control" value="{{ is_null(old("name")) ? $company_website->name : old("name") }}"/>
                       @if($errors->has("name"))
                    ...
                    <input type="text" id="url-field" name="url" class="form-control" value="{{ is_null(old("url")) ? $company_website->url : old("url") }}"/>
                       @if($errors->has("url"))
