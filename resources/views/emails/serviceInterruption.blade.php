                                                            ...
                                                            <td>
                                                                <div>
                                                                    <p style="font-size: 14px;color: #181818;margin:0px">
                                                                        ...
                                                                        <br>
                                                                        <br>
                                                                        Please be advised that the platform will be under maintainance from 5:00 PM to 6:00 PM IST on October 27th, 2018. This period of downtime is scheduled for necessary updates to be applied to the network servers. We apologise for the inconvenience that this may cause.
                                                                        <br>
                                                                        <br>
                                                                        Regards,
                                                                        <br>
