                                                ...
                                                <tr>
                                                    <td>
                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#FFFFFF">
                                                            <tr>
                                                                <td bgcolor="#FFFFFF">
                                                                    <div style="font-size: 16px;color: #181818;">{{substr($data->model->content, 0, 50)}}<span style="color: #4397E7;">(more)</span></div>
                                                                </td>
                                                            </tr>   
                                                        </table>
                                                    </td>
                                        ...
                                        <td bgcolor="#FFFFFF" align= "center">
                                            <div style="padding: 0px 40px;">
                                                <div style="padding: 20px 0px;border-bottom: 1px solid rgba(0,0,0,0.2);">
                                                    <img src="{{$data->model->image}}" width="350px"	height=230px"/>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
