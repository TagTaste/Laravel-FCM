                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <td>
                                                                <div>
                                                                    <p style="font-size: 14px;color: #181818;margin:0px">
                                                                        ...
                                                                        <br>
                                                                        <br>
                                                                        Congratulations! {{$data->who['name']}} has accepted your invitation to review your products on TagTaste.
                                                                        <br>
                                                                        <br>
                                                                    </p>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td valign="top" align="center" bgcolor="#FFFFFF">
                                                                ...
                                                                @else
                                                                    <a href="{{env('APP_URL')}}/collaborations/{{$model['id']}}"style="display: inline-block;text-decoration: none;padding: 14px 24px;color: #FFFFFF;background-color: #D9222A;box-shadow: none;border: none;font-size: 16px;margin: 31px 0px 31px 0px;border-radius: 24px;font-weight: normal;">View Collaboration</a>
                                                                @endif
                                                            </td>
                                                        </tr>
                                                    </table>
