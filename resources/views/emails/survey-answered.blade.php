                                                            ...
                                                            <td>
                                                                <div>
                                                                    <p style="font-size: 14px;color: #181818;margin:0px">
                                                                        ...
                                                                        <br>
                                                                        <br>
                                                                        <b>{{$data->who['name']}}</b>  has invited you to taste their products and provide feedback. Click on the link below to accept the invitation.
                                                            ...
                                                            <td valign="top" align="center"  bgcolor="#FFFFFF" >
                                                                <div>
                                                                    ...
                                                                    <?php 
                                                                        $deep_link_status = 1;
                                                                        try{
                                                                            \App\Deeplink::getShortLink("surveys", $model["id"]);
                                                                        } catch(Exception $e) {
                                                                            $link_status = 0;
                                                                        }
                                                                    ?>
                                                                    @if($deep_link_status) 
                                                                        <a href='{{ \App\Deeplink::getShortLink("surveys", $model["id"]) }}' style="text-decoration:none;padding: 15px 36px;border-radius: 1px;color: #FFFFFF;background-color: #D9222A;box-shadow: none;border: none;font-size: 18px;border-radius: 30px; font-weight: normal">Accept Invitation</a>
                                                                    @else
                                                                        <a href="{{env('APP_URL')}}/surveys/{{$model['id']}}" style="text-decoration:none;padding: 15px 36px;border-radius: 1px;color: #FFFFFF;background-color: #D9222A;box-shadow: none;border: none;font-size: 18px;border-radius: 30px; font-weight: normal">Accept Invitation</a>
                                                                    @endif
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div>
                                                                    ...
                                                                    <p style="font-size: 14px;color: #181818;margin:0px">
                                                                        <b>PS:</b> Read <a href="https://blog.tagtaste.com/product-reviews-how-sleepy-owl-used-tagtaste-for-blind-panel-tasting-of-cold-brew-coffee-1e89c2f5b037" style="color:#0D86E3">our blog</a> to know more about Product Reviews.
                                                                    </p>
