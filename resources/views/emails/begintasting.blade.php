                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top" align="center"  bgcolor="#FFFFFF" >
                                                                <div>
                                                                    ...
                                                                    @else
                                                                        <br><a href="{{env('APP_URL')}}/collaborations/{{$model['id']}}" style="text-decoration:none;padding: 15px 36px;border-radius: 1px;color: #FFFFFF;background-color: #D9222A;box-shadow: none;border: none;font-size: 18px;border-radius: 30px; font-weight: normal">Begin Tasting</a>
                                                                    @endif
                                                                </div>
                                                            </td>
