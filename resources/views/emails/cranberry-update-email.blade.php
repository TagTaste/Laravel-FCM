                                                ...
                                                <td align="center" valign="top" width="100%">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#FFFFFF">
                                                        <tr>
                                                            <td>
                                                                <div>
                                                                    <div style="width:100%; text-align: center;"><img style="max-width: 100%; height: auto; padding: 0; margin: 0;" src=https://s3.ap-south-1.amazonaws.com/static3.tagtaste.com/dashboard/images/yygu3dgrepm6dbse8ujgl.png /></div>
                                                                </div>
                                                            </td>
                                                        </tr>
