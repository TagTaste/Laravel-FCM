                                                            ...
                                                            <td>
                                                                <div>
                                                                    <p style="font-size: 14px;color: #181818;margin:0px; line-height: 1.5;">
                                                                        ...
                                                                        <br />
                                                                        <br />
                                                                        Covid-19 pandemic is perfect storm of variables that has already changed the restaurant culture. Many of these variables have little to do with food.
                                                                        <br />
                                                                        <br />
                                                                        Here’s an attempt based on industry trends and market research to help you understand and navigate through the impact of Covid-19 and the shift that accompanies it for the ‘Future of Food’.  We call it a Covid-19 Survival Plan on how to rebuild our businesses!
                                                                        <br />
                                                                        <br />
