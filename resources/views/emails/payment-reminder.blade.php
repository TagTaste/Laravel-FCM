                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td bgcolor="#FFFFFF" align="left">
                                                                    <p style="color: #171717; margin: 0px;font-size: 16px;font-weight: normal;">
                                                                        Hi {{$data['content']['Name']}},
                                                                    </p>
                                                                    <div style="color: #171717;margin: 16px 0px 0px 0px;font-size: 16px;line-height: 1.5;">
                                                                      <span >Please complete your payment for Model {{$data['content']['Model']}} !!</span ><br />
                                                                        <a href="{{$data['content']['Link']}}">Click here to complete the payment!</a><br />
                                                                      <span>
                                                                     As the payment is going to expire in 2 Days!</span>
                                                                    </div>
