                            ...
                            <table width= "550" align="center" border="0" cellspacing="0" cellpadding="0"  border-collapse="collapse">
                                ...
                                <tr>
                                    <td align="center" bgcolor="#FFFFFF">
                                        <div style="color: #181818;font-family: Arial;	font-size: 20px;font-weight: bold;">Create Your Password</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top" class="logo" align="center" style="padding: 20px 40px 0px 40px;border-radius: 0px 0px 5px 5px;" bgcolor="#FFFFFF">
                                        <div style="font-size: 16px;color: #181818;">You recently made a request to create a password for your TagTaste account. Click the button below to complete the process.</div>
                                    </td>
                                </tr>
                                <tr>
                                                    ...
                                                    <table>
                                                        ...
                                                        <tr>
                                                            <td valign="top" align="center"  bgcolor="#FFFFFF " >
                                                                ...
                                                                <a href="https://www.tagtaste.com/password/create/{{$token}}?email={{$email}}" style="text-decoration:none;padding: 15px 36px;border-radius: 4px;color: #FFFFFF;background-color: #D9222A;box-shadow: none;border: none;font-size: 18px;border-radius: 30px; font-weight: normal">CREATE PASSWORD</a>
