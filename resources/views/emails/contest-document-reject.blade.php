                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div style="color:#181818; font-weight:regular; line-height: 1.5;">
                                                                    ...
                                                                    <br />
                                                                    <br />
                                                                    Admin has requested you to reupload the documents for collaboration {{$data->title}}.
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td valign="top" align="center" bgcolor="#FFFFFF">
                                                                <a href="{{env('APP_URL')}}/collaborations/{{$model['id']}}?rejected_documents=1" style="display: inline-block;text-decoration: none;padding: 14px 24px;color: #FFFFFF;background-color: #D9222A;box-shadow: none;border: none;font-size: 16px;margin: 31px 0px 31px 0px;border-radius: 24px;font-weight: normal;">
                                                                    Reupload Documents
                                                                </a>
                                                            </td>
                                                        </tr>
