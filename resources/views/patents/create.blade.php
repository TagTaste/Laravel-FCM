...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-plus"></i> Patents / Create </h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('patents.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('title')) has-error @endif">
                    ...
                    <input type="text" id="issued_by-field" name="issued_by" class="form-control" value="{{ old("issued_by") }}"/>
                    ...
                    <input type="text" id="awarded_on-field" name="awarded_on" class="form-control date-picker" value="{{ old("awarded_on") }}"/>
