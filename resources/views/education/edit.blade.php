...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Education / Edit #{{$education->id}}</h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('education.update', $education->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('degree')) has-error @endif">
                    ...
                    <input type="text" id="degree-field" name="degree" class="form-control" value="{{ is_null(old("degree")) ? $education->degree : old("degree") }}"/>
                    ...
                    <input type="text" id="college-field" name="college" class="form-control" value="{{ is_null(old("college")) ? $education->college : old("college") }}"/>
                    ...
                    <input type="text" id="field-field" name="field" class="form-control" value="{{ is_null(old("field")) ? $education->field : old("field") }}"/>
                       @if($errors->has("field"))
                    ...
                    <input type="text" id="grade-field" name="grade" class="form-control" value="{{ is_null(old("grade")) ? $education->grade : old("grade") }}"/>
                       @if($errors->has("grade"))
                    ...
                    <input type="text" id="percentage-field" name="percentage" class="form-control" value="{{ is_null(old("percentage")) ? $education->percentage : old("percentage") }}"/>
                    ...
                    <textarea class="form-control" id="description-field" rows="3" name="description">{{ is_null(old("description")) ? $education->description : old("description") }}</textarea>
                    ...
                    <input type="text" id="start_date-field" name="start_date" class="form-control date-picker" value="{{ is_null(old("start_date")) ? $education->start_date : old("start_date") }}"/>
                    ...
                    <input type="text" id="end_date-field" name="end_date" class="form-control date-picker" value="{{ is_null(old("end_date")) ? $education->end_date : old("end_date") }}"/>
                    ...
                    <input type="text" id="profile_id-field" name="profile_id" class="form-control" value="{{ is_null(old("profile_id")) ? $education->profile_id : old("profile_id") }}"/>
