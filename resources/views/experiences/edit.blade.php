...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Experiences / Edit #{{$experience->id}}</h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('experiences.update', $experience->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('company')) has-error @endif">
                    ...
                    <input type="text" id="company-field" name="company" class="form-control" value="{{ is_null(old("company")) ? $experience->company : old("company") }}"/>
                    ...
                    <input type="text" id="designation-field" name="designation" class="form-control" value="{{ is_null(old("designation")) ? $experience->designation : old("designation") }}"/>
                    ...
                    <textarea class="form-control" id="description-field" rows="3" name="description">{{ is_null(old("description")) ? $experience->description : old("description") }}</textarea>
                    ...
                    <textarea class="form-control" id="location-field" rows="3" name="location">{{ is_null(old("location")) ? $experience->location : old("location") }}</textarea>
                    ...
                    <input type="text" id="end_date-field" name="end_date" class="form-control date-picker" value="{{ is_null(old("end_date")) ? $experience->end_date : old("end_date") }}"/>
                    ...
                    <input type="text" id="profile_id-field" name="profile_id" class="form-control" value="{{ is_null(old("profile_id")) ? $experience->profile_id : old("profile_id") }}"/>
