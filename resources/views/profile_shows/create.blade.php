...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-plus"></i> ProfileShows / Create </h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('profile_shows.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('title')) has-error @endif">
                    ...
                    <input type="text" id="channel-field" name="channel" class="form-control" value="{{ old("channel") }}"/>
                    ...
                    <input type="text" id="appeared_as-field" name="appeared_as" class="form-control" value="{{ old("appeared_as") }}"/>
