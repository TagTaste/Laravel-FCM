...
<div class="col-md-4">
	<div class="row">
		...
		<div class="com-md-4">
			<form action="{{ route('dish_articles.destroy', $article->id) }}" method="POST" style="display: inline;" onsubmit="if(confirm('Delete? Are you sure?')) { return true } else {return false };">
