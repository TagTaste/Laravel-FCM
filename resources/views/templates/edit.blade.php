        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('templates.update', $template->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('name')) has-error @endif">
                    ...
                    <input type="text" id="template_type_id-field" name="template_type_id" class="form-control" value="{{ is_null(old("template_type_id")) ? $template->template_type_id : old("template_type_id") }}"/>
