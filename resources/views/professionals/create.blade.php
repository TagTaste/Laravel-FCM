...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-plus"></i> Professionals / Create </h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('professionals.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('ingredients')) has-error @endif">
                    ...
                    <textarea class="form-control" id="ingredients-field" rows="3" name="ingredients">{{ old("ingredients") }}</textarea>
                    ...
                    <textarea class="form-control" id="favourite_moments-field" rows="3" name="favourite_moments">{{ old("favourite_moments") }}</textarea>
