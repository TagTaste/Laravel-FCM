...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Companies / Edit #{{$company->id}}</h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('companies.update', $company->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('name')) has-error @endif">
                    ...
                    <input type="text" id="name-field" name="name" class="form-control" value="{{ is_null(old("name")) ? $company->name : old("name") }}"/>
                       @if($errors->has("name"))
                    ...
                    <textarea class="form-control" id="about-field" rows="3" name="about">{{ is_null(old("about")) ? $company->about : old("about") }}</textarea>
                       @if($errors->has("about"))
                    ...
                    <textarea class="form-control" id="logo-field" rows="3" name="logo">{{ is_null(old("logo")) ? $company->logo : old("logo") }}</textarea>
                       @if($errors->has("logo"))
                    ...
                    <textarea class="form-control" id="hero_image-field" rows="3" name="hero_image">{{ is_null(old("hero_image")) ? $company->hero_image : old("hero_image") }}</textarea>
                    ...
                    <input type="text" id="phone-field" name="phone" class="form-control" value="{{ is_null(old("phone")) ? $company->phone : old("phone") }}"/>
                       @if($errors->has("phone"))
                    ...
                    <input type="text" id="email-field" name="email" class="form-control" value="{{ is_null(old("email")) ? $company->email : old("email") }}"/>
                       @if($errors->has("email"))
                    ...
                    <textarea class="form-control" id="registered_address-field" rows="3" name="registered_address">{{ is_null(old("registered_address")) ? $company->registered_address : old("registered_address") }}</textarea>
                    ...
                    <input type="text" id="established_on-field" name="established_on" class="form-control date-picker" value="{{ is_null(old("established_on")) ? $company->established_on : old("established_on") }}"/>
                    ...
                    <input type="text" id="employee_count-field" name="employee_count" class="form-control" value="{{ is_null(old("employee_count")) ? $company->employee_count : old("employee_count") }}"/>
                    ...
                    <input type="text" id="client_count-field" name="client_count" class="form-control" value="{{ is_null(old("client_count")) ? $company->client_count : old("client_count") }}"/>
                    ...
                    <input type="text" id="annual_revenue_start-field" name="annual_revenue_start" class="form-control" value="{{ is_null(old("annual_revenue_start")) ? $company->annual_revenue_start : old("annual_revenue_start") }}"/>
                    ...
                    <input type="text" id="annual_revenue_end-field" name="annual_revenue_end" class="form-control" value="{{ is_null(old("annual_revenue_end")) ? $company->annual_revenue_end : old("annual_revenue_end") }}"/>
                    ...
                    <input type="text" id="facebook_url-field" name="facebook_url" class="form-control" value="{{ is_null(old("facebook_url")) ? $company->facebook_url : old("facebook_url") }}"/>
                    ...
                    <input type="text" id="twitter_url-field" name="twitter_url" class="form-control" value="{{ is_null(old("twitter_url")) ? $company->twitter_url : old("twitter_url") }}"/>
                    ...
                    <input type="text" id="linkedin_url-field" name="linkedin_url" class="form-control" value="{{ is_null(old("linkedin_url")) ? $company->linkedin_url : old("linkedin_url") }}"/>
                    ...
                    <input type="text" id="instagram_url-field" name="instagram_url" class="form-control" value="{{ is_null(old("instagram_url")) ? $company->instagram_url : old("instagram_url") }}"/>
                    ...
                    <input type="text" id="youtube_url-field" name="youtube_url" class="form-control" value="{{ is_null(old("youtube_url")) ? $company->youtube_url : old("youtube_url") }}"/>
                    ...
                    <input type="text" id="pinterest_url-field" name="pinterest_url" class="form-control" value="{{ is_null(old("pinterest_url")) ? $company->pinterest_url : old("pinterest_url") }}"/>
                    ...
                    <input type="text" id="google_plus_url-field" name="google_plus_url" class="form-control" value="{{ is_null(old("google_plus_url")) ? $company->google_plus_url : old("google_plus_url") }}"/>
                    ...
                    <input type="text" id="user_id-field" name="user_id" class="form-control" value="{{ is_null(old("user_id")) ? $company->user_id : old("user_id") }}"/>
