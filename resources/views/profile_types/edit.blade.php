        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('profile_types.update', $profile_type->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('type')) has-error @endif">
                    ...
                    <div class="btn-group" data-toggle="buttons"><label class="btn btn-primary"><input type="radio" value="1" name="enabled" id="enabled" autocomplete="off"> 1</label><label class="btn btn-primary active"><input type="radio" name="enabled" value="0" id="enabled" autocomplete="off"> 0</label></div>
                    ...
                    <div class="btn-group" data-toggle="buttons"><label class="btn btn-primary"><input type="radio" value="1" name="default" id="default" autocomplete="off"> 1</label><label class="btn btn-primary active"><input type="radio" name="default" value="0" id="default" autocomplete="off"> 0</label></div>
