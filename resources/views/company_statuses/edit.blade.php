        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('company.status.update', $company_status->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('name')) has-error @endif">
                    ...
                    <input type="text" id="name-field" name="name" class="form-control" value="{{ is_null(old("name")) ? $company_status->name : old("name") }}"/>
                       @if($errors->has("name"))
                    ...
                    <textarea class="form-control" id="description-field" rows="3" name="description">{{ is_null(old("description")) ? $company_status->description : old("description") }}</textarea>
