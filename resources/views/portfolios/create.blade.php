...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-plus"></i> Portfolios / Create </h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('portfolios.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('worked_for')) has-error @endif">
                    ...
                    <textarea class="form-control" id="worked_for-field" rows="3" name="worked_for">{{ old("worked_for") }}</textarea>
