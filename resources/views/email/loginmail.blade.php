                    ...
                    <table width= "620" align="center" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" border-collapse="collapse" style="padding:20px;margin-top: 50px;margin-bottom:50px;">
                        ...
                        <tr>
                            <td style="color: rgba(0,0,0,0.9);font-size: 16px;font-family: helvetica neue;">
                                <p style="margin-bottom:0px;color: rgba(0,0,0,0.9);"> Dear {{$name}}, </p>
                            </td>
                        </tr>

                        <tr>
                            <td padding="11px 0px 0px 0px" style="color: rgba(0,0,0,0.9);font-size: 16px;font-family: helvetica neue;">
                                <p style="margin-bottom: 20px;">With reference to your recent registration on the TagTaste platform, we are delighted to inform you that our <span style="color: #0027F9;">Live Beta Trial </span>commences today. We are only desktop / laptop friendly as of now and based on your feedback over the next three to four weeks, we intend to roll out our mobile applications as well. We request you to start enjoying the features and functionality of your platform and keep giving us your valuable feedback at <a href="mailto:feedback@tagtaste.com" style="text-decoration:none;color:#0027F9 ">feedback@tagtaste.com</a>.
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <td padding="11px 0px 0px 0px" style="color: rgba(0,0,0,0.9);font-size: 16px;font-family: helvetica neue;">
                                <p style="margin-bottom: 20px;"> We are honored to be working closely with you to make TagTaste a better platform. Here are your account details:</p>
                            </td>
                        </tr>
                        <tr>
                            <td padding="11px 0px 0px 0px" style="color: rgba(0,0,0,0.9);font-size: 16px;font-family: helvetica neue;">
                        ...
                        <tr style="font-family: helvetica neue;">
                            <td>
                                <p style="font-size: 18px;font-weight: bold; margin: 40px 0px 0px 0px;color:#000">What is TagTaste?</p>
                                <p style="color: rgba(0,0,0,0.8);font-size: 16px; margin: 0px;">TagTaste is an online community for food professionals to discover, network and collaborate with each other.</p>
                            </td>
                        </tr>
                        <tr style="font-family: helvetica neue;">
                            <td>
                        ...
                        <tr style="font-family: helvetica neue;">
                            <td>
                                <p style="color: rgba(0,0,0,0.9);font-size: 16px;font-weight: 600;margin:25px 0px 0px 0px;">Cheers,</p>
                                <p  style="color: rgba(0,0,0,0.9);font-size: 16px;font-weight: 600;margin:0px">Team Tag Taste</p>
                            </td>
                        </tr>
                    </table>
                </tr>
...
<table class="container" width= "620" align="center" border="0" cellspacing="10" cellpadding="0"  border-collapse="collapse" style="font-family:helvetica neue">
    <tr style="font-family: helvetica neue;">
        <td align="center" style="color:#000000">
            {{--<p style="margin:0px;"><a href="#" style="text-decoration:none;color: #0027F9;">Unsubscribe</a> from further communications about this email</p>--}}
        </td>
