                    ...
                    <table width= "620" align="center" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" border-collapse="collapse" style="padding:20px;margin-top: 50px;margin-bottom:0px;">
                        ...
                        <tr>
                            <td padding="11px 0px 0px 0px" style="color: rgba(0,0,0,0.9);font-size: 16px;font-family: helvetica neue;">
                                <p style="margin: 0px 0px 0px 0px;">
                                    We are delighted to share with you that TagTaste is live in Beta!
                                </p>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr style="font-family: helvetica neue;">
                            <td>
                                ...
                                <p style="color: rgba(0,0,0,0.8);font-size: 16px; margin: 0px;">Please contact us at <a href="mailto:contact@tagtaste.com" style="text-decoration:none;color: #0027F9;">contact@tagtaste.com</a>. We’ll be happy to respond.</p>
                            </td>
                        </tr>
                        <tr style="font-family: helvetica neue;">
                            <td>
