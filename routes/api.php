...
//                return response($str, 200, $headers);
    ...
    Route::get("csv/college2",function (Request $request){
        $this->model = [];
        $productIds = \DB::table('public_product_user_review')->where('current_status',2)->where('source',2)
            ->orderBy('id', 'DESC')->get()->pluck('product_id');
        $productInfo = \App\PublicReviewProduct::whereIn('id',$productIds)->skip(30)->take(30)->get();
        $data = [];
        $index = 1;
        foreach ($productInfo as $item)
        {
    ...
    Route::get("csv/college3",function (Request $request){
        $this->model = [];
        $productIds = \DB::table('public_product_user_review')->where('current_status',2)->where('source',2)
            ->orderBy('id', 'DESC')->get()->pluck('product_id');
        $productInfo = \App\PublicReviewProduct::whereIn('id',$productIds)->skip(30)->take(30)->get();
    ...
    Route::get("csv/college4",function (Request $request){
        $this->model = [];
        $productIds = \DB::table('public_product_user_review')->where('current_status',2)->where('source',2)
            ->orderBy('id', 'DESC')->get()->pluck('product_id');
        $productInfo = \App\PublicReviewProduct::whereIn('id',$productIds)->skip(30)->take(30)->get();
    ...
    Route::get("csv/college5",function (Request $request){
        $this->model = [];
        $productIds = \DB::table('public_product_user_review')->where('current_status',2)->where('source',2)
            ->orderBy('id', 'DESC')->get()->pluck('product_id');
        $productInfo = \App\PublicReviewProduct::whereIn('id',$productIds)->skip(30)->take(30)->get();
    ...
    Route::get("csv/college6",function (Request $request){
        $this->model = [];
        $productIds = \DB::table('public_product_user_review')->where('current_status',2)->where('source',2)
            ->orderBy('id', 'DESC')->get()->pluck('product_id');
        $productInfo = \App\PublicReviewProduct::whereIn('id',$productIds)->skip(30)->take(30)->get();
    ...
    Route::get("csv/college7",function (Request $request){
        $this->model = [];
        $productIds = \DB::table('public_product_user_review')->where('current_status',2)->where('source',2)
            ->orderBy('id', 'DESC')->get()->pluck('product_id');
        $productInfo = \App\PublicReviewProduct::whereIn('id',$productIds)->skip(30)->take(30)->get();
    ...
    Route::get("csv/college8",function (Request $request){
        $this->model = [];
        $productIds = \DB::table('public_product_user_review')->where('current_status',2)->where('source',2)
            ->orderBy('id', 'DESC')->get()->pluck('product_id');
        $productInfo = \App\PublicReviewProduct::whereIn('id',$productIds)->skip(30)->take(30)->get();
    ...
    Route::get("csv/college9",function (Request $request){
        $this->model = [];
        $productIds = \DB::table('public_product_user_review')->where('current_status',2)->where('source',2)
            ->orderBy('id', 'DESC')->get()->pluck('product_id');
        $productInfo = \App\PublicReviewProduct::whereIn('id',$productIds)->skip(30)->take(30)->get();
    ...
    Route::get("csv/college10",function (Request $request){
        $this->model = [];
        $productIds = \DB::table('public_product_user_review')->where('current_status',2)->where('source',2)
            ->orderBy('id', 'DESC')->get()->pluck('product_id');
        $productInfo = \App\PublicReviewProduct::whereIn('id',$productIds)->skip(30)->take(30)->get();
    ...
    Route::get("csv/college11",function (Request $request){
        $this->model = [];
        $productIds = \DB::table('public_product_user_review')->where('current_status',2)->where('source',2)
            ->orderBy('id', 'DESC')->get()->pluck('product_id');
        $productInfo = \App\PublicReviewProduct::whereIn('id',$productIds)->skip(30)->take(30)->get();
    ...
    Route::get("csv/college12",function (Request $request){
        $this->model = [];
        $productIds = \DB::table('public_product_user_review')->where('current_status',2)->where('source',2)
            ->orderBy('id', 'DESC')->get()->pluck('product_id');
        $productInfo = \App\PublicReviewProduct::whereIn('id',$productIds)->skip(30)->take(30)->get();
