    ...
    //authenticated routes.
        Route::middleware(['api.auth','optimizeImages'])->group(function(){
            ...
            Route::group(['namespace'=>'V1','prefix'=>'v1/','as'=>'v1.'],function() {
                ...
                //search apis new
                Route::get("public-review/explore","SearchController@explore");
            ...
            Route::post("public-review/products/{id}/uploadImageProduct","PublicReviewProductController@uploadImage");
