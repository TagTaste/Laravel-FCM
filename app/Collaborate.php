...
class Collaborate extends Model implements Feedable
{
    ...
    protected $fillable = ['title', 'i_am', 'looking_for', 'expires_on','video','location',
        ...
        'brand_name','brand_logo','no_of_batches','global_question_id','taster_instruction','image_meta'];
    ...
    protected $visible = ['id','title', 'i_am', 'looking_for',
        ...
        'brand_name','brand_logo','no_of_batches','collaborate_allergens','global_question_id','taster_instruction','image_meta'];
