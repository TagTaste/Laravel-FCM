...
class Collaborate extends Model implements Feedable
{
  ...
  protected $visible = ['id','title', 'i_am', 'looking_for',
        ...
        'brand_name','brand_logo','no_of_batches','collaborate_allergens','global_question_id','taster_instruction','images_meta','owner','document_required','track_consistency','is_contest','max_submissions','show_interest_state'];
