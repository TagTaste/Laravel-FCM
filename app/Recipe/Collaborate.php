...
class Collaborate extends BaseCollaborate
{
    ...
    protected $visible = ['id','title', 'i_am', 'looking_for',
        ...
        'profile','company','images','is_taster_residence','addresses','categories','type','collaborate_type','images_meta','track_consistency','is_contest','max_submissions','show_interest_state'];
