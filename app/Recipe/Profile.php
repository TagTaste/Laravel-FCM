...
class Profile extends BaseProfile
{
    ...
    protected $visible = ['id','name', 'designation','imageUrl','tagline','about','handle','city','expertise','user_id',
        'keywords','image','isFollowing','ageRange','gender',"image_meta","hero_image_meta",'is_ttfb_user','verified','is_tasting_expert','phone','tasting_instructions','is_premium','hometown','is_paid_taster','is_sensory_trained'];
