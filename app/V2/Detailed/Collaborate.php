...
<<<<<<< HEAD
	protected $visible = ['id','title','expires_on','profile_id','company_id','created_at','updated_at','deleted_at','video','location','privacy_id','description','duration','file1','state','step','type','type_id','is_taster_residence','collaborate_type','brand_name','brand_logo','methodology_id','no_of_batches','global_question_id','images_meta','applicationCount','type','product_review_meta','tasting_methodology','profile','company','categories','addresses','collaborate_specializations','collaborate_allergens','description_updated', 'document_required', 'financials','financial_min','financial_max','track_consistency','is_contest','max_submissions','mandatory_fields'];
=======
    protected $visible = ['id','title','expires_on',
                            'profile_id','company_id','created_at',
                            'updated_at','deleted_at','video',
                            'location','privacy_id','description',
                            'duration','file1','state',
                            'step','type','type_id',
                            'is_taster_residence','collaborate_type','brand_name',
                            'brand_logo','methodology_id','no_of_batches',
                            'global_question_id','images_meta','applicationCount',
                            'type','product_review_meta','tasting_methodology','profile',
                            'company','categories','addresses',
                            'collaborate_specializations','collaborate_allergens','description_updated',
                             'document_required', 'financials','financial_min',
                             'financial_max','track_consistency','is_contest',
                             'max_submissions','show_interest_state'];
>>>>>>> 232310a41622161cd69592c3ca14d36674273078

    protected $appends = ['description_updated', 'applicationCount', 'product_review_meta', 'type','tasting_methodology','addresses','mandatory_fields'];
