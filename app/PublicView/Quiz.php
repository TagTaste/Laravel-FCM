...
class Quiz extends BaseQuiz
{
    ...
    protected $visible = ["id","profile_id","company_id","title","replay","description","image_meta","video_meta","videos_meta","expired_at","is_active","state","deleted_at","owner","profile","company"];
