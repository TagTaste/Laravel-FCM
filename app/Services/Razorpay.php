...
class Razorpay  
{
    ...
    public static function createLink($paramArray = [])
    {
        ...
        $parameters["contact"] = ["name"=>$paramArray["name"],"email"=>$paramArray["beneficiaryEmail"],"contact"=>$paramArray["beneficiaryPhoneNo"],"type"=>"Taster"];
        // $paramArray["callbackUrl"] = config("payment.PAYTM_CALLBACK_URL");
        $parameters["amount"] = $paramArray["amount"];
