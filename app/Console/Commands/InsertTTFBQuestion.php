...
class InsertTTFBQuestion extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'ttfbquestion:insert';
     ...
     * @var string
     */
    protected $description = 'Insert a TTFB global question';
    ...
    public function handle()
    {
        ...
        $data = [
            'name' => 'Private_McD_Shake_Shake_Fries_21Dec2020', 'keywords' => "Private_McD_Shake_Shake_Fries_21Dec2020", 'description' => null,
            'question_json' => $questions2, 'header_info' => json_encode($headerInfo2, true), 'track_consistency' => $track_consistency
        ];
        \DB::connection('mysql_ttfb')->table('ttfb_global_questions')->insert($data);
    }
}
