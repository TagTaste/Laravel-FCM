...
class InsertPublicReviewQuestionair extends Command
{
	...
	"TEXTURE": [{
			...
			"title": "Take sufficient quantity of the product (Bhatura). Bite 2-3 times and pause. What kind of sound do you hear?",
	...
	"PRODUCT EXPERIENCE": [{
        ...
        $data = ['name'=>'Generic - Bhatura','keywords'=>"Generic - Bhatura",'description'=>null,
