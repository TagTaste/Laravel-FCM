...
class InsertPublicReviewQuestionair extends Command
{
    ...
    public function handle()
    {
        $headerInfo2 = [
            ...
            ['header_name'=>"TASTE","header_info"=> ["text" => "<i>Slurp noisily and assess the tastes.</i><br><br>All the tastes except Umami are self-explanatory. <b> Umami </b> taste is felt when you get a continuous secretion of saliva; taste is felt on the entire tongue, throat, roof, back of the mouth; has a long lasting aftertaste; and some people crave for more."]],
	...
	"INSTRUCTIONS": [
...

		{
			...
			"title": "<u>INSTRUCTION</u>",

			"subtitle": "<b>Welcome to the Product Review!</b><br><br><u>If a product involves stirring, shaking etc. (like cold coffee) then the taster must follow the instructions fully, as mentioned on the packaging. To review, follow the questionnaire and select the answers that match with your observations. Please note that you are reviewing the product and NOT the package.</u><br><br>Remember, there are no right or wrong answers. Let\'s start by opening the package.",
	...
	"APPEARANCE": [
...

		{
			...
			"title": "<u>for testing underline >> What was the serving temperature of the product?</u>",
...

		{
			...
			"title": "<i>for testing italic >> How was the visual impression (color and hue) of the product?</i>",
...

		{
			...
			"title": "<u>How was the visual texture of the product?</u>",
...

		{
			...
			"title": "<b>Overall preference of Appearance</b>",
	...
	"AROMA": [
...

		{
			...
			"subtitle": "Directly use the search box to select the aromas that you observed or follow the category based aroma list. In case you can\'t find the observed aromas, select <b>Any other</b> and if unable to sense any aromas at all, then select <b>Absent</b>.",
...

		{
			...
			"title": "<u>Overall preference of Aroma</u>",
	...
	"AROMATICS TO FLAVORS": [
...

		{
			...
			"subtitle": "Directly use the search box to select the aromatics that you observed or follow the category based aromatics list. In case you can\'t find the observed aromatics, select <b>Any other</b> and if unable to sense any aromatics at all, then select <b>Absent</b>.",
...

		{
			...
			"title": "<i>Swallow the product. How was the aftertaste?</i>",
