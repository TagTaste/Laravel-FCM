...
class InsertPublicReviewQuestionair extends Command
{
    ...
    public function handle()
    {
        $headerInfo2 = [
            ...
            ['header_name'=>"AROMATICS TO FLAVORS","header_info"=> ["text" => "Slurp noisily again,<br> keeping your <b>MOUTH CLOSED</b> and <b>EXHALE THROUGH THE NOSE</b>. Identify the odors that come from inside the mouth; these observed odors are called Aromatics."],'header_selection_type'=>"1"],
