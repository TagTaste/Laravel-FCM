...
"subtitle": "You may also touch the product to assess the serving temperature.",
...

		{
			...
			"title": "How are the sizes of majority of the product pieces?",
...

		{
			...
			"title": "How is the shape of majority of the product?",
"subtitle": "Mushroom - Popped in round shape\nButterfly - Popped with separate wings\nHull - Outer layer of kernel (seed)",
	...
	"AROMATICS TO FLAVORS": [
       ...
       "title": "What all aromatics have you sensed?",
...

		{
			...
			"title": "Which prominent trending flavor do you feel in the product?",
...

{
	...
	"PRODUCT EXPERIENCE": [
        ...
        $data = ['name'=>'generic_popcorn_v2','keywords'=>"generic_popcorn_v2",'description'=>null,
