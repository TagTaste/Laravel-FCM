...

{
    ...
    "PRODUCT EXPERIENCE": [{
        ...
        $data = ['name'=>'Sliced Bread_Private_Modern','keywords'=>"Sliced Bread_Private_Modern",'description'=>null,
