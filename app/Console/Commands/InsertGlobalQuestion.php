...
class InsertGlobalQuestion extends Command
{
	...
	"APPEARANCE": [{
		...
		"question": [{
			...
			"is_nested_question": 0,
			"is_mandatory": 1,
            "option": "White,Pearl,Snow,Ivory (Elephant Tusk),Cream,Egg Shell,Cotton,Salt,Bone,Frost (Dew),Bone China,Butter Paper,Rice (Raw rice)"
		}, {
			"title": "Surface appearance",
			"select_type": 2,
			"is_intensity": 0,
	...
	"OVERALL PREFERENCE": [{
        ...
        $data = ['name'=>'Raw Garlic','keywords'=>"Garlic",'description'=>null,
            'question_json'=>$questions2,'header_info'=>json_encode($headerInfo2,true)];
        \DB::table('global_questions')->insert($data);
	...
	"APPEARANCE": [{
		...
		"question": [{
			...
			"is_nested_question": 0,
			"is_mandatory": 1,
            "option": "Rust,Brown sugar,Brownie,Bronze,Copper,Clay,Coffee,Chocolate,Cinnamon"
		}, {
			"title": "Surface appearance",
			"select_type": 2,
			"is_intensity": 0,
	...
	"OVERALL PREFERENCE": [{
        ...
        $data = ['name'=>'Raw Tamarind','keywords'=>"Tamarind",'description'=>null,
            'question_json'=>$questions2,'header_info'=>json_encode($headerInfo2,true)];
        \DB::table('global_questions')->insert($data);
