...
class InsertGlobalQuestion extends Command
{
	...
	"ORAL TEXTURE": [{
		...
		"question": [{
			...
			"is_nested_question": 0,
			"is_mandatory": 1,
			"option": "No Saliva Absorbed,Barely Any Saliva Absorbed,Very Slightly Saliva Absorbed,Slightly Saliva Absorbed,Moderately Saliva Absorbed,Plenty Saliva Absorbed,Loads of Saliva Absorbed,Extremely High quantity"
		}, {
	...
	"OVERALL PREFERENCE": [{
        ...
        $data = ['name'=>'Muffins 1','keywords'=>"Muffins",'description'=>null,
