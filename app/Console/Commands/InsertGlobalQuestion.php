...
class InsertGlobalQuestion extends Command
{
    ...
    public function handle()
    {
        $headerInfo2 = [
            ...
            ['header_name' => "APPEARANCE",'header_selection_type'=>1 ,"header_info" => ["text" => "Examine the product visually and answer the questions outlined below."]],


            ['header_name' => "AROMA",'header_selection_type'=>1,"header_info" => ["text" => "At this stage, we are assessing only aromas (odors) through the nose, so please don't eat yet. Now bring the product closer to your nose and take a deep breath; you may also take 3-4 short, quick and strong sniffs. Aroma/s arising from the product can be traced to the ingredients and the processes (like baking, cooking, fermentation etc) which the product might have undergone."]],


            ['header_name' => "TASTE",'header_selection_type'=>1,"header_info" => ["text" => "Eat normally and assess the tastes.\n\nAll the tastes except Umami are self-explanatory. Umami taste is felt when you get a continuous secretion of saliva; taste is felt on the entire tongue, throat, roof, back of the mouth; has a long lasting aftertaste and some people crave for more."]],



            ['header_name' => "AROMATICS",'header_selection_type'=>1,"header_info" => ["text" => "Eat normally with your MOUTH CLOSED and EXHALE THROUGH THE NOSE. Identify the odors that come from inside the mouth; these observed odors are called Aromatics."]],



            ['header_name' => "TEXTURE",'header_selection_type'=>1,"header_info" => ["text" => "Let's experience the Texture (Feel) now. ‘Feel’ starts when the product comes in contact with the mouth and the ‘Feel’ may even last after the product has been swallowed. Texture (Feel) is all about the joy we get from what we eat."]],



            ['header_name' => "PRODUCT EXPERIENCE",'header_selection_type'=>2,"header_info" => ["text" => "Consider all the attributes - Appearance, Aroma, Taste, Aromatics to flavors and Texture; rate the overall experience of the product on all the parameters taken together."]]
...
"intensity_color":"#000000,#000011,#001100,#110000,#100001,#010010,#100100",
"is_nested_question": 0,
"is_mandatory": 1,
"is_nested_option": 1,
...
"is_nested_question": 0
        ...
        $data = ['name'=>'Honey Application with nested option','keywords'=>"Honey Application (Kejriwal)",'description'=>null,
