...
class InsertGlobalQuestion extends Command
{
    ...
    public function handle()
    {
        ...
        ['header_name' => "AROMATICS TO FLAVORS","header_info" => ["text" => "Eat normally with your MOUTH CLOSED and EXHALE THROUGH THE NOSE. Identify the odor/s that come from inside the mouth; these observed odors are called Aromatics."]],
...
"PRODUCT EXPERIENCE": [{
        ...
        $data = ['name'=>'Roti_Private','keywords'=>"Roti_Private",'description'=>null,
