...
class InsertGlobalQuestion extends Command
{
	...
	{
	"title": " with numeric intensity - How is the color of the product",
	"select_type": 2,
	"is_intensity": 1,
	"is_nested": 0,
	"is_mandatory": 1,
	...
	"is_nested_question": 0
        ...
        $data = ['name'=>'For testing - with numeric intensity','keywords'=>"french fries",'description'=>null,
