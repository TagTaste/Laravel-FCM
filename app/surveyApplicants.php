...
class surveyApplicants extends Model
{
    ...
    // protected $visible = ['id','profile_id','survey_id','is_invited','profile','message','hut','created_at','updated_at','city','age_group','gender','company','company_id','document_meta','terms_verified', 'documents_verified','phone','submission_count','hometown','current_city','is_donation','donation_organisation_id'];
