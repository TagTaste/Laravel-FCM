...
class RemoveDuplicateFromAppInfo implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        file_put_contents(storage_path("logs") . "/notification_test.txt", "deleting fcm tokens for ids except : ".$idToStoreArr, FILE_APPEND);
        ...
        file_put_contents(storage_path("logs") . "/notification_test.txt", "deleting emulator fcm tokens : ", FILE_APPEND);
        file_put_contents(storage_path("logs") . "/notification_test.txt", "++++++++++++++++++++++++\n\n", FILE_APPEND);
