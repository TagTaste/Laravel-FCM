...
class ReviewCollectionElement extends Model
{
    ...
    protected $visible = ['id','type','collection_id','data_type','data_id','data_model','filter_id','filter_name','filter_image','filter_on','filter','filter_meta','filter_images_meta','images_meta','title','subtitle','description','image','created_at','updated_at','deleted_at'];
