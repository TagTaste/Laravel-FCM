...
class BatchController extends Controller
{
    ...
    public function reportSummary(Request $request, $collaborateId)
    {
        ...
        $overAllPreference = \DB::table('collaborate_tasting_user_review')->join('collaborate_tasting_header','collaborate_tasting_questions.header_type_id','=','collaborate_tasting_header.id')
            ...
            ->orderBy('collaborate_tasting_header.id','collaborate_tasting_user_review.header_type_id','collaborate_tasting_user_review.batch_id')->groupBy('collaborate_tasting_user_review.question_id',
