...
class QuizController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->has("expired_at") && !empty($request->expired_at) && (strtotime($request->expired_at) > strtotime("+12 months   "))) {
            return $this->sendNewError("Expiry time exceeds one year");
        }
