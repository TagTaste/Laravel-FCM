...
class CollaborateController extends Controller
{
    ...
    public function applications(Request $request, $id)
    {
        ...
        $this->model['archived'] = \App\Collaboration\Collaborator::whereNotNull('rejected_on')->where('collaborate_id',$id)->with('profile','collaborate')->get();
        $this->model['applications'] = \App\Collaboration\Collaborator::whereNull('rejected_on')->where('collaborate_id',$id)->with('profile','collaborate')->get();
