        ...
        if (is_null($search_value)) {
            ...
            if ($search_filter === "everything" || $search_filter == null) {
                ...
                $model[] = [
                    ...
                    "ui_type" => 4,
                    "ui_style_meta" => (object)[],
                    "title" => "Top ".str_plural("result", $profile_elastic_data['top_result'])." in people", 
                    "subtitle" => null,
                    "description" => null,
                    "images_meta" => null,
                    "type" => "collection",
                ...
                $model[] = [
                    ...
                    "ui_type" => 2,
                    "ui_style_meta" => (object)[],
                    "title" => "Top ".str_plural("result", $product_elastic_data['top_result'])." in product",
                    "subtitle" => null,
                    "description" => null,
                    "images_meta" => null,
                    "type" => "collection",
                ...
                $model[] = [
                    ...
                    "ui_type" => 6,
                    "ui_style_meta" => (object)[],
                    "title" => "Top ".str_plural("result", $collaborate_elastic_data['top_result'])." in collaborate", 
                    "subtitle" => null,
                    "description" => null,
                    "images_meta" => null,
                    "type" => "collection",
                ...
                $model[] = [
                    ...
                    "ui_type" => 7,
                    "ui_style_meta" => (object)[],
                    "title" => "Top ".str_plural("result", $company_elastic_data['top_result'])." in company", 
                    "subtitle" => null,
                    "description" => null,
                    "images_meta" => null,
                    "type" => "collection",
