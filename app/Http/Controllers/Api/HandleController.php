...
class HandleController extends Controller
{
	...
	{
	  $model = Profile::join('users','profiles.user_id','=','users.id')->select('profiles.id','users.name as profile_name')->where('users.account_deactivated', false)->where('profiles.handle','like',$handle)->first();
