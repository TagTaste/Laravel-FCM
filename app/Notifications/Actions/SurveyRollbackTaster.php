...
class SurveyRollbackTaster extends Action
{
    public $view;
    public $sub;
    public $notification ;
    ...
    public function __construct($event)
    {
        ...
        if($event->model->is_invited){
            $this->sub = htmlspecialchars_decode($this->data->who['name']) ." assigned survey (".$event->model->ntitleame.") by mistake and it has been reversed.";
        }
        else
        $this->sub = htmlspecialchars_decode($this->data->who['name']) ." assigned survey (".$event->model->ntitleame.") by mistake and it has been reversed.";
